...
_DATA_DIR = _PROJECT_DIR / "jsons"
DATA_FILE = str(_DATA_DIR / "traced_theorems_unified_v2.jsonl")
OUTPUT_PDF = str(_PROJECT_DIR / "theorem_premise_network_analysis.pdf")
OUTPUT_PNG = str(_PROJECT_DIR / "theorem_premise_network_analysis.png")
OUTPUT_PDF_EGONETS = str(_PROJECT_DIR / "theorem_premise_network_analysis_egonets.pdf")
OUTPUT_PNG_EGONETS = str(_PROJECT_DIR / "theorem_premise_network_analysis_egonets.png")
OUTPUT_PDF_MOTIFS = str(_PROJECT_DIR / "theorem_premise_network_analysis_motifs.pdf")
OUTPUT_PNG_MOTIFS = str(_PROJECT_DIR / "theorem_premise_network_analysis_motifs.png")
OUTPUT_HTML_DASHBOARD = str(_PROJECT_DIR / "theorem_ego_network_dashboard.html")
